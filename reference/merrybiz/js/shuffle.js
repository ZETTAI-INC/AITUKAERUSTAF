...
(function(d, g) {
  d.fn.sorted = function(b) {
    var c = d.extend({}, d.fn.sorted.defaults, b),
      b = this.get();
    c.by !== d.noop &&
      null !== c.by &&
      void 0 !== c.by &&
  ...
  var i = function(b, c) {
    var a = this;
    d.extend(a, d.fn.shuffle.options, c, d.fn.shuffle.settings);
    a.$container = b;
    a.$items = a.$container.children();
    a.$item = a.$items.first();
    ...
    a.$container.css("position", "relative").get(0).style[a.transitionName] =
      "height " + a.speed + "ms " + a.easing;
    a.$items.each(function() {
      d(this).css(a.itemCss);
      a.supported &&
        (this.style[a.transitionName] =
          a.transform +
          " " +
          a.speed +
          "ms " +
    ...
    a.itemWidth = a.$item.outerWidth();
    a.itemHeight = a.$item.outerHeight();
    ...
    d(window).on("resize.shuffle", function() {
      ...
      if (c !== a.windowWidth || b !== a.windowHeight)
        a.resized(), (a.windowHeight = b), (a.windowWidth = c);
    });
  ...
  i.prototype = {
    ...
    shuffle: function(b) {
      ...
      d.isFunction(b)
        ? c.$items.each(function() {
            var a = d(this);
            a.addClass(b(a, c) ? "filtered" : "concealed");
          })
        : ((c.group = b),
          "all" !== b
            ? c.$items.each(function() {
                ...
                -1 === d.inArray(b, a)
                  ? d(this).addClass("concealed")
                  : d(this).addClass("filtered");
              })
            : c.$items.addClass("filtered"));
      c.visibleItems = c.$items.filter(".filtered").length;
      c.fire("shrink");
      c.shrink();
      c.fire("filter");
      c.filter();
    ...
    getItemsPerRow: function() {
      ...
      c * (this.itemWidth + this.marginRight) - this.marginRight > b &&
        (c -= 1);
      return c;
    },
    resizeContainer: function() {
      var b =
        Math.ceil(this.visibleItems / this.itemsPerRow) *
          (this.itemHeight + this.marginTop) -
        this.marginTop;
    ...
    filter: function() {
      if (this.keepSorted && this.lastSort) this.sort(this.lastSort, !0);
      else {
        var b = this.$items.filter(".filtered").get();
        this.layout(b, this.filterEnd);
      }
    },
    sort: function(b, c) {
      var a = this,
        d = a.$items.filter(".filtered").sorted(b);
      a.layout(d, function() {
        c && a.filterEnd();
        a.sortEnd();
      });
    ...
    transition: function(b) {
      var c = this,
        a,
        d = function() {
          !c.layoutTransitionEnded && "layout" === b.from
            ? (b.callback.call(c), (c.layoutTransitionEnded = !0))
            : !c.shrinkTransitionEnded &&
              "shrink" === b.from &&
              (b.callback.call(c), (c.shrinkTransitionEnded = !0));
        };
      c.supported
        ? ((a = c.threeD
            ? "translate3d(" +
    ...
    resized: function() {
      this.itemWidth = this.$items.filter(".filtered").outerWidth();
      this.itemHeight = this.$items.filter(".filtered").outerHeight();
    ...
    destroy: function() {
      this.$container.removeAttr("style").removeData("shuffle");
  ...
  d.fn.shuffle.options = {
    group: "all",
    speed: 800,
    easing: "ease-out",
    keepSorted: !0
  };
  d.fn.shuffle.settings = {
