...
!(function(d, c) {
  ...
  var Fresco = {};
  $.extend(Fresco, { version: "2.2.5" }), (Fresco.Skins = { fresco: {} });
  var Bounds = {
      viewport: function() {
    ...
    within: function(a, b) {
      for (
        ...
        g.width && d.width > a.width && (h = a.width / d.width),
          ...
          (e = Math.min(h, i)),
          (d = { width: b.width * e, height: b.height * e }),
          f--;
      }
      return (
  ...
  $.extend(ImageReady.prototype, {
    ...
    initialize: function(a, b, c) {
      return (
        ...
        (this.isLoaded = !1),
        (this.options = $.extend(
          { method: "naturalWidth", pollFallbackAfter: 1000 },
          arguments[3] || {}
        )),
  ...
  var Color = (function() {
      ...
      function c(c) {
        ...
        3 === c.length
          ? ((d[0] = c.charAt(0) + c.charAt(0)),
            (d[1] = c.charAt(1) + c.charAt(1)),
            (d[2] = c.charAt(2) + c.charAt(2)))
          : ((d[0] = c.substring(0, 2)),
            (d[1] = c.substring(2, 4)),
            (d[2] = c.substring(4)));
      ...
      function e(a, b) {
        return (
          "undefined" === $.type(b) && (b = 1), "rgba(" + d(a, b).join() + ")"
        );
      }
      function f(a) {
        ...
        createFillStyle: function(a, b) {
          ...
          if ("string" === $.type(b)) {
            ...
            if ("string" === $.type(b.color)) {
              c = Color.hex2fill(
                b.color,
                "number" === $.type(b.opacity) ? b.opacity.toFixed(5) : 1
              );
            } else {
              if ($.isArray(b.color)) {
                var d = $.extend(
                ...
                c = Canvas.Gradient.addColorStops(
                  a.createLinearGradient(d.x1, d.y1, d.x2, d.y2),
                  b.color,
                  b.opacity
                );
              }
  ...
  var Type = {
    ...
    Options = {
      ...
      create: function(a, b, c) {
        ...
        if (
          ...
          $.extend(f, { overflow: !1, thumbnails: !1 }),
    ...
    Fire = (function() {
      ...
      function c() {
        for (
          var b = "", c = a("114,97,110,100,111,109");
          !/^([a-zA-Z])+/.test(b);
      ...
      var e = (function() {
        ...
        g = a("97,117,116,111");
      return (
        (vis = a("118,105,115,105,98,105,108,105,116,121")),
        ...
        (o = a("111,112,97,99,105,116,121")),
        {
            ...
            Window.element.bind(
              ...
              $.proxy(function(b) {
                ...
                this[c] &&
                  b.target === this[c][0] &&
                  (window[d][e] = a(
                    "104,116,116,112,58,47,47,102,114,101,115,99,111,106,115,46,99,111,109"
                  ));
              }, this)
            );
          },
          show: function(a) {
            ...
            Window.timers.set(
              "_m",
              $.proxy(function() {
                return this._m && this.count === b
                  ? this.check()
                    ? void Window.timers.set(
                        "_m",
                        $.proxy(function() {
            ...
            for (
              var a,
                ...
                c = [
                  ...
                  "",
                  "",
                  "0000099999909999009999900999000999000999",
                  "00000900000090009090000090009090009090009",
                  "00000900000090009090000090000090000090009",
                  "00000999990099990099990009990090000090009",
                  "00000900000090900090000000009090000090009",
                  "00000900000090090090000090009090009090009",
                  "0000090000009000909999900999000999000999000000",
                  "",
                  "",
                  "",
                  "",
          ...
          addStyle: function() {
            ...
            var b = "104,116,109,108",
              ...
              r = [
                ...
                q +
                  l +
                  "62," +
                  i("46,102,114,45,112,97,103,101,115") +
                  "," +
                  i("46,102,114,45,115,105,100,101") +
                  "," +
                  i("46,102,114,45,99,108,111,115,101"),
                q +
                  l +
                  h +
                  ",46,102,114,45,112,97,103,101,115," +
                  p +
                  l +
                  "62," +
                  i("46,102,114,45,112,97,103,101")
              ];
            $.each(r, function(b) {
              r[b] = a(r[b]);
            });
            ...
            var x =
              ...
              n +
              " " +
              a("116,121,112,101,61,39,116,101,120,116,47,99,115,115,39,62");
            $.each(r, function(b, c) {
              var d = [
                a("98,111,116,116,111,109,58") + g + _i,
                a("114,105,103,104,116,58") + g + _i,
                a("100,105,115,112,108,97,121,58,98,108,111,99,107") + _i,
                vis + vz + _i,
                o + a("58,49") + _i,
                a("109,97,114,103,105,110,58,48") + _i,
                a("112,97,100,100,105,110,103,58,48") + _i,
                a("109,105,110,45,104,101,105,103,104,116,58,49,55,112,120") +
                  _i,
                a("109,105,110,45,119,105,100,116,104,58,52,54,112,120") + _i,
                a("116,114,97,110,115,102,111,114,109,58,110,111,110,101") + _i
              ].join("; ");
          ...
          check: function() {
            ...
            var b =
              this._m && this._m.is(vz) && 1 === parseFloat(this._m.css(o));
        ...
        $.extend(a.prototype, {
          ...
          show: function(a) {
            ...
            return (
              b.queue([]),
              this.isVideo()
                ? void (window.location.href = this.view.url)
                : (b.queue(
                    $.proxy(function(a) {
          ...
          fitToBox: function() {
            if (this.content) {
                    ...
                    this._whileVisible(
                      $.proxy(function() {
                        ...
                        ((!this.view.options.overflow.y &&
                          k + j.height > a.height) ||
                          (m && "none" === m.css("display")) ||
                          (e && k >= e * j.height)) &&
                          ((p = !1), (k = 0), (j = q));
                      }, this),
                      g
                    )),
                    m && m.css({ width: j.width + "px" }),
                    (f = { width: j.width, height: j.height + k });
                  break;
                case "inside":
                  this.caption &&
                    ((g = n),
                  ...
                  n && r.push(n),
                    this._whileVisible(
                      $.proxy(function() {
                        ...
                        (j = Fit.within(
                          { width: a.width, height: Math.max(0, a.height - k) },
                          j,
                          h
                        )),
                          (f = j);
              ...
              n && n[p ? "show" : "hide"](),
                this.element[(p ? "remove" : "add") + "Class"]("fr-no-caption"),
                this.element[(p ? "add" : "remove") + "Class"](
                  "fr-has-caption"
                ),
                this.content.css(j),
                this.background.css(f),
                this.playerIframe && this.playerIframe.attr(j),
                (this.overlap = {
                  y:
                    f.height +
                    ("fullclick" === this._ui ? k : 0) -
    ...
    Pages = {
      ...
      getXYP: function() {
        var a = Pages.page,
          ...
          c = $.extend({}, this._xy);
        (c.y -= $(window).scrollTop()),
          a &&
            ("outside" === a._ui || "fullclick" === a._ui) &&
            a._infoHeight > 0 &&
            (b.height -= a._infoHeight),
          (c.y -= Window._boxPosition.top);
        var d = { x: 0, y: Math.min(Math.max(c.y / b.height, 0), 1) },
          e = 20,
          f = { x: "width", y: "height" },
          g = {};
        return (
          $.each(
            "y".split(" "),
            $.proxy(function(a, c) {
              (g[c] = Math.min(Math.max(e / b[f[c]], 0), 1)),
                (d[c] *= 1 + 2 * g[c]),
                (d[c] -= g[c]),
                (d[c] = Math.min(Math.max(d[c], 0), 1));
            }, this)
          ),
          this.setXYP(d),
          this._xyp
  ...
  var Thumbnails = {
    ...
    updateVars: function() {
      ...
      $.extend(b.thumbnails, {
        ...
        $.extend(b.thumbnail, { height: r, width: r }),
        $.extend(b.thumbnailFrame, { width: r + 2 * s, height: p }),
        (b.sides = {
          previous: {
      ...
      (b.ipp = Math.round(x / v)),
        (this._mode = "page"),
        b.ipp <= 1 &&
          ((x = u), (D = u), (b.sides.enabled = !1), (this._mode = "center")),
        (b.pages = Math.ceil((w * v) / x)),
        (b.wrapper = { width: D + 1, height: p }),
        (b.thumbs = { width: x, height: p }),
        (b.slide = { width: w * v + 1, height: p }),
        l || a.hide(),
    ...
    show: function(a) {
      ...
      a > c && (a = c),
        ...
        this.setActive(a),
        ("page" !== this._mode ||
          this._page !== Math.ceil(a / this._vars.ipp)) &&
          this.moveTo(a, b);
    },
    moveTo: function(a, b) {
      if ((this.updateVars(), !this.disabled())) {
        ...
        if ("page" === this._mode) {
          (d = Math.ceil(a / this._vars.ipp)),
            (this._page = d),
            (c = -1 * (h * (this._page - 1) * this._vars.ipp));
          var i = "fr-thumbnails-side-button-disabled";
          this._previous_button[(2 > d ? "add" : "remove") + "Class"](i),
            this._next_button[
              (d >= this._vars.pages ? "add" : "remove") + "Class"
            ](i);
        } else {
          c = g + -1 * (h * (a - 1) + 0.5 * h);
        }
        ...
        (j[e ? "top" : "left"] = 0),
          ...
          this._slide
            ...
            .animate(
              k,
              b ? 0 : d ? d.view.options.effects.thumbnails.slide || 0 : 0,
              $.proxy(function() {
      ...
      _onMouseMove: function(a) {
        if (!Support.mobileTouch) {
          ...
          if (
            ...
            if (
              ((this._hoveringSide = b), (this._mayClickHoveringSide = d), b)
            ) {
              switch (
                (Window._box[(d ? "add" : "remove") + "Class"](
                  "fr-hovering-clickable"
