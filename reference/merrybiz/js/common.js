(function () {
  ...
  function loopCreate() {
    ...
    for (var _i = 0; _i < appendSlides.length; _i += 1) {
      $selector.append($$1(appendSlides[_i].cloneNode(true)).addClass(params.slideDuplicateClass));
    }

    for (var _i2 = prependSlides.length - 1; _i2 >= 0; _i2 -= 1) {
      $selector.prepend($$1(prependSlides[_i2].cloneNode(true)).addClass(params.slideDuplicateClass));
    }
  }
  ...
  $(function () {
    // var navEventSP = function() {
    //   var w =
    //     window.innerWidth ||
    //     document.documentElement.clientWidth ||
    //     document.body.clientWidth;
    //   if (w <= 1023) {
    //     $(".st-header_navList-mega").off("mouseover mouseout click");
    //     $(".st-header_navList-megaItem").off("click");
    //     $(".st-footer_navList-megaItem").off("click");
    //     $(".st-header_navList-mega").removeClass("is-show");
    //     $(".st-footer_navList-mega").removeClass("is-show");
    //     if ($(".st-header_navList").hasClass("is-pc")) {
    //       $(".st-header_navList")
    //         .css("display", "")
    //         .height("");
    //     }
    //     $(".st-header_navList").removeClass("is-pc");
    //     $(".st-header_navList").addClass("is-sp");
    //     $(".st-header_navList-megaItem").on("click", function() {
    //       $(".st-header_navList-megaContent")
    //         .height("")
    //         .css("padding", "");
    //       $(this)
    //         .parent(".st-header_navList-mega")
    //         .toggleClass("is-show");
    //       $(this)
    //         .parent(".st-header_navList-mega")
    //         .children(".st-header_navList-megaContent")
    //         .stop()
    //         .slideToggle();
    //     });
    //     $(".st-footer_navList-megaContent").css("display", "none");
    //     $(".st-footer_navList-megaItem").on("click", function() {
    //       $(this)
    //         .parent(".st-footer_navList-mega")
    //         .toggleClass("is-show");
    //       $(this)
    //         .parent(".st-footer_navList-mega")
    //         .children(".st-footer_navList-megaContent")
    //         .stop()
    //         .slideToggle();
    //     });
    //   }
    // };
    // var navEventPC = function() {
    //   var w =
    //     window.innerWidth ||
    //     document.documentElement.clientWidth ||
    //     document.body.clientWidth;
    ...
    //     $(".st-header_navList-mega").off("mouseover mouseout click");
    //     $(".st-footer_navList-megaItem").off("click");
    //     $(".st-header_navList").addClass("is-pc");
    //     $(".st-header_navList").removeClass("is-sp");
    //     $(".st-header_toggle").removeClass("is-show");
    //     $(".st-header_button").removeClass("is-show");
    //     $(".st-header_navList-megaContent").css("display", "none");
    //     $(".no-js").removeClass("remodal-is-locked");
    //     $(".st-header_navList")
    //       .css("display", "flex")
    //       .height("100%");
    //     $(".st-header_navList-mega").on("mouseover", function() {
    //       $(".st-header_navList-megaContent")
    //         .height("")
    //         .css("padding", "");
    //       $(this)
    ...
    //         .slideDown();
    //     });
    //     $(".st-header_navList-mega").on("mouseout", function() {
    //       $(".st-header_navList-megaContent")
    //         .height("")
    //         .css("padding", "");
    //       $(this)
    ...
    //         .slideUp();
    //     });
    //     $(".st-footer_navList-megaContent").css("display", "block");
    //   }
    // };
    // navEventPC();
    // navEventSP();
    ...
    $(window).on("resize", function () {
      ...
      if (currentWidth <= 1023 && mode == "PC") {
        navEventSP();
        mode = "SP";
      } else if (currentWidth >= 1024 && mode == "SP") {
        navEventPC();
        mode = "PC";
      }
    });
    $(".st-header_toggle").on("click", function () {
      var hSize = window.innerHeight;
      $(".st-header_navList").height(hSize - 56);
      $(this).toggleClass("is-show");
      $(".st-header_button").toggleClass("is-show");
      $(".no-js").toggleClass("remodal-is-locked");
      $(".st-header_navList").stop().toggleClass("is-show").slideToggle();
    });
    $("a[href^='#']").on("click", function () {
      if ($(".st-header_navList").is(":visible") && $(".sp-nav").is(":visible")) {
        console.log("test");
        $(".st-header_navList").slideToggle();
      }

      if ($(".st-header_toggle").hasClass("is-show")) {
        $(".st-header_toggle").removeClass("is-show");
      }

      if ($(".no-js").hasClass("remodal-is-locked")) {
        $(".no-js").removeClass("remodal-is-locked");
      }
    });
    var startPos = 0,
        hH = $(".st-header").innerHeight();
    $(window).on("scroll", function () {
      var currentPos = $(this).scrollTop();

      if (currentPos > startPos) {
        if ($(window).scrollTop() >= 200) {
          $(".st-header").addClass("is-hidden");
        }
      } else if (currentPos < startPos) {
        $(".st-header").removeClass("is-hidden");
      }

      startPos = currentPos; // if (startPos >= hH && startPos >= lastPos) {
      //   $(".st-header").addClass("is-hidden");
      // } else if () {
      //   $(".st-header").removeClass("is-hidden");
      // }
    ...
    // const hH = $(".st-header").innerHeight();
    // let pos = 0;
    ...
    var truncationElements = document.querySelectorAll(".textOverflowTest");

    if (truncationElements) {
      for (var i = 0; i < truncationElements.length; ++i) {
        if (!("WebkitLineClamp" in truncationElements[i].style)) {
          var $target = $(truncationElements[i]); // オリジナルの文章を取得する
          ...
          $target.html($clone.html()); //$clone.remove();
        }
      }
    }

    $(".faqList_item dt").on("click", function () {
  ...
  $(function () {
    var $input = $(".js-search_input");

    if (!$input.val()) {
      $(".js-search_button").prop("disabled", true);
    }

    $input.on("input", function () {
      if (!!$input.val().match(/\S/g)) {
        $(".js-search_button").prop("disabled", false);
      } else {
        $(".js-search_button").prop("disabled", true);
      }
    });
  ...
  $(function () {
    if ($("#columnList").length) {
      ...
      if (path.match("/page/") || ref.match("/column/page/")) {
        var $target = $("#columnList");
  ...
  $(function () {
    var navEventSP = function navEventSP() {
      var w = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth;

      if (w <= 1119) {
        $(".js-mega").on("click", function () {
          $(".js-megaContent").height("").css("padding", "");
          $(this).children(".js-megaContent").stop().slideToggle();
        });
      }
    };

    var navEventPC = function navEventPC() {
      var w = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth;

      if (w >= 1120) {
        $(".js-mega").on("mouseover", function () {
          $(".js-megaContent").height("").css("padding", "");
          $(this).children(".js-megaContent").stop().slideDown();
        });
        $(".js-mega").on("mouseout", function () {
          $(".js-megaContent").height("").css("padding", "");
          $(this).children(".js-megaContent").stop().slideUp();
        });
      }
    };
    ...
    $(window).on("resize", function () {
      ...
      if (currentWidth <= 1119 && mode == "PC") {
        navEventSP();
        mode = "SP";
      } else if (currentWidth >= 1120 && mode == "SP") {
        navEventPC();
        mode = "PC";
      }
    });
    $("a[href^='#']").on("click", function () {
      var headerHight = $(".st-header").height();
      var speed = 1000;
      var href = $(this).attr("href");
      var target = $(href == "#" || href == "" ? "html" : href);

      if ($(".st-header_top").css("display") === "none") {
